    ...
    const fetchAuthors = async () => {
      try {
        ...
        if (response.data && Array.isArray(response.data.Authors)) {
          ...
          //console.log(response.data.a_pic);
        } else {
            ...
            {loading ? (
              ...
              welcomeQuote && (
                <div className="quote-box">
                  <p style={{ fontSize: '1.5em', fontStyle: 'italic', color: 'white', textShadow: '2px 2px 4px rgba(0,0,0,0.5)' }}>
                    {welcomeQuote.description ? welcomeQuote.description : "No quote available"}
                  </p>
                  <small style={{ color: 'white', textShadow: '1px 1px 2px rgba(0,0,0,0.5)' }}>
            ...
            <div className="featured-box" style={{ backgroundImage: `url(${image})` }} key={index}>
              <div className="quote-container">
                {featuredQuotes[index] && (
                  <div className="quote-box">
                    <p style={{ fontSize: '1.2em', color: 'white', marginTop: '40px', textAlign: 'center', textShadow: '2px 2px 4px rgba(0,0,0,0.5)' }}>
                      {featuredQuotes[index].description ? featuredQuotes[index].description : "No quote available"}
                    </p>
                    <small style={{ color: 'white', fontFamily: 'sans-serif', fontStyle: 'italic', marginLeft: '25px', alignSelf: 'center', textShadow: '1px 1px 2px rgba(0,0,0,0.5)' }}>
